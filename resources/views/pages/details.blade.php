...
     @endsession
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="card" style="height: 80vh; max-height: 80vh;">
                    <div class="card-header d-flex align-1items-center justify-content-between overflow-hidden">
                        <h3 class="rw-bold fs-4 text-truncate mb-0" 
                        style="widht: 80%">Details</h3>
                    </div>
